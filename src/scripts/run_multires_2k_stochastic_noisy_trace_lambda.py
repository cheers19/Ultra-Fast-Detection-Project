"""Multires 2K on stochastic SASE pulses — noisy-train λ search (SNR 0–30 dB train, val @ 15 dB)."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="checkpoints/benchmark/stochastic_multires_2k_noisy_trace_lambda.npz",
    )
    parser.add_argument(
        "--meta-json",
        default="checkpoints/benchmark/stochastic_multires_2k_noisy_trace_lambda_meta.json",
    )
    parser.add_argument(
        "--sweep-output",
        default="checkpoints/benchmark/stochastic_multires_2k_noisy_trace_lambda_opt_sweep.npz",
    )
    parser.add_argument(
        "--baseline-sweep-output",
        default="checkpoints/benchmark/stochastic_multires_2k_noisy_trace_lambda_baseline_sweep.npz",
    )
    parser.add_argument(
        "--ckpt-dir",
        default="checkpoints/benchmark/stochastic_multires_2k_noisy_trace_lambda",
    )
    parser.add_argument(
        "--opt-checkpoint",
        default="checkpoints/benchmark/stochastic_multires_2k_noisy_trace_lambda_opt.pt",
    )
    ...
    stoch_grid = StochasticPulseConfig(n=n)
