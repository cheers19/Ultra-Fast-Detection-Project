"""Create Protocol v2 plain Multires notebook for n_train=7207."""
...
OUT = Path(__file__).resolve().parent / "plain_multires_n7207_v2_NB.ipynb"
...
cells.append(
    md(
        r"""# Data-efficiency v2 — Plain Multires, \(n_{\mathrm{train}}=7207\)
...
Artifacts: `checkpoints/v2/n7207_plain/` under this folder.
...
OUT = EXP / "checkpoints" / "v2" / "n7207_plain"
