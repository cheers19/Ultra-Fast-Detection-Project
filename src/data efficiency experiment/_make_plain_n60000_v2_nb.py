"""Create Protocol v2 plain Multires notebook for n_train=60000."""
...
OUT = Path(__file__).resolve().parent / "plain_multires_n60000_v2_NB.ipynb"
...
cells.append(
    md(
        r"""# Data-efficiency v2 — Plain Multires, \(n_{\mathrm{train}}=60000\)
...
Artifacts: `checkpoints/v2/n60000_plain/` under this folder.
...
OUT = EXP / "checkpoints" / "v2" / "n60000_plain"
