"""Create Protocol v2 plain Multires notebook for n_train=20794."""
...
OUT = Path(__file__).resolve().parent / "plain_multires_n20794_v2_NB.ipynb"
...
cells.append(
    md(
        r"""# Data-efficiency v2 — Plain Multires, \(n_{\mathrm{train}}=20794\)
