"""Create Protocol v2 Band-B physics Multires notebook for n_train=20794."""
...
OUT = Path(__file__).resolve().parent / "physics_multires_n20794_v2_NB.ipynb"
...
cells.append(
    md(
        r"""# Data-efficiency v2 — Physics Multires, \(n_{\mathrm{train}}=20794\) (Band B)
...
Artifacts: `checkpoints/v2/n20794_physics/` (includes `*_train_state.pt` per screen).
...
OUT = EXP / "checkpoints" / "v2" / "n20794_physics"
OUT.mkdir(parents=True, exist_ok=True)
PLAIN_OUT = EXP / "checkpoints" / "v2" / "n20794_plain"
