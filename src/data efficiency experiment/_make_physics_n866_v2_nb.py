"""Create Protocol v2 physics Multires notebook for n_train=866."""
...
OUT = Path(__file__).resolve().parent / "physics_multires_n866_v2_NB.ipynb"
...
cells.append(
    md(
        r"""# Data-efficiency v2 — Physics Multires, \(n_{\mathrm{train}}=866\)
...
OUT = EXP / "checkpoints" / "v2" / "n866_physics"
OUT.mkdir(parents=True, exist_ok=True)
PLAIN_OUT = EXP / "checkpoints" / "v2" / "n866_plain"
...
# PROTOCOL v2 §5.2
LAMBDA_COARSE = [0.75, 1.5, 3.0, 6.0, 12.0]
